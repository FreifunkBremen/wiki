...
Leider sind die Erweiterungen nicht upgradefest. Ein Upgrade erezugt immer wieder die Originalgröße des Images und löscht weitere Partitionen. Ein Fix in Gluon ist in Arbeit.
Fall 1: Die vorhandene Partition wurde vergrößert und ein sysupgrade durchgeführt. Hier ist nichts mehr zu Retten.
Fall 2: Es wurde eine dritte Partition sda3 erstellt und gemounted. Diese ist nach einem sysupgrade verschwunden.
...
# ok, hätte klappen können, also Formatieren!
