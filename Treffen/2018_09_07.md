...
- Frank_H:Bin dieses Treffen nicht dabei, hatte einige Probleme mit der 2018.1.1
  - Archer C7v2 kein 5Ghz Mesh
  - WBS510v1 kein 5Ghz Mesh
  - Ubiquiti ER-X WAN Port für diesen Chipsatz fest auf 100Mb, der ER-X hat 5*1Gb Ports. Lokale Änderung über swconfig/ethtool nicht möglich, da eth0.2 nicht konfigurierbar.
  - X86 Image nur über ssh ansprechbar. Installierte Dienste können nicht angesprochen werden. Hier: Irc-Bouncer ZNC & Icecast
  - Rückfall auf 2017.1.8 nur über Original-FW. Org-Image über bootloader und TFT installierbar.
  - X86 Futro Rückfall schrottet HDD, Image nicht per USB installierbar, da HDD Read Only. Externer Kartenleser erforderlich.
