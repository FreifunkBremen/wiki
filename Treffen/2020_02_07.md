...
- -> FrankH berichtet: WBS510 hat sehr niedrige Sendeleistung (s.u.)

### 2019.1.1-bremen1
* Sollte jetzt testing sein.
- -> Ist jetzt Testing.
* Alles gut?
* -> Louis hatte bei einer CPE210 ein Problem mit `autoupdater -f` (Upgrade ist einfach nicht durchgelaufen); hat später beim zeitbasierten Upgrade aber funktioniert
* Tests abgeschlossen
  * Gut gelaufen? [Siehe das Protokoll vom 17.01.2020](https://wiki.bremen.freifunk.net/Treffen/2020_01_17#protokoll_firmware_2019-1-1-domain-switching)
  * [Checkliste](https://github.com/FreifunkBremen/gluon-site-ffhb/issues/36) abgearbeitet
* Kann der Zeitplan mit dem 05.03.2020 eingehalten werden?
  * Kann sie bereits jetzt als stabil definiert werden?
      * -> von der Funktionalität her wohl schon
      * -> aber: alle Router mit der 2019.1.1-bremen1 werden automatisch auf 11s umschalten, wenn sie mehr als 2 Stunden offline sind!
    * -> Planung: am 25.2.2020 wird die FW als Stable veröffentlicht
* Blog-Post draußen? [ja](https://bremen.freifunk.net/blog/2020/01/23/wechsel-von-ibss-zu-11s.html)
* Anleitung für manuelle Umstellung!
  * [Screenshots](https://bremen.freifunk.net/anleitungen.html) generell veraltet
      * -> ein Hinweis bzgl. Domain wurde eingebaut
      * -> [Issue](https://github.com/FreifunkBremen/bremen.freifunk.net/issues/123) mit weiteren Anmerkungen erstellt
...
* -> Debugging läuft
* -> falls das ein echtes Problem ist: mal an Gluon melden, damit das nicht unbekannt bleibt?
...
* Aufgaben
    ...
    * Software/Virtuell
        * Firmware
            * Build
            * Write/Portkonfiguration
            * Hardcoded max wifi clients
        * Speziel Config (non Gluon)
            * extra Switche
            * Richtfunk
            * Uplink (!)
        * Monitoring
            ...
            * (Logs)
        * Konfigurieren (Gluon)
            * Geokoordinaten/Namen ...
            * Channel
            * Ansible
            * Freifunkmanager
    * Hardware/Kabel
        * APs - Leih vs. verschiedene Firmware
        * Welche Kabel Wo
            * Empfehlung: nur EINE Person sollte LWL zusammenstecken (war zu oft falsch zusammengesteckt; führte zu 80% der Probleme, trotz Funkgerät und Beschriftung)
        * Flashen
        * 
...
* Haben wir letztes Mal noch drüber geprochen, das Ticket ist aber mittlerweile zu weil die sich nicht melden. Thema durch oder auf Grund der ganzen anderen Richtfunkdinge in der Gegend noch interessant?
* Gab ne E-Mail von Ed dazu. Gibts da neues?
* -> noch nicht; evtl. gehts im Frühjahr weiter
...
* Ist der Router jetzt aktualisiert und auf Auto-Update?
* Ist für die Umstellung wichtig.
* -> nein, ist tatsächlich nicht wichtig
* -> Geno wird trotzdem bei Gelegenheit ein Update machen
...
* Schon jemand was gebaut? Nein, erstmal 11s
* Offene Fragen siehe letztes [Protokoll](https://wiki.bremen.freifunk.net/Treffen/2020_01_17#protokoll_offline-ssid)
* -> sollten wir vor der Batman-Umstellung machen!
