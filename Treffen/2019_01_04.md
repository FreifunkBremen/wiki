...
* Idee: Workshops Video-technisch aufnehmen. Es muss Leute geben, die sich filmen lassen, filmen, schneiden, bereitstellen.
* Alternativ: Ohne Videoaufnahme

### Sternma-Neuinstallation / Cafe Sand
* Es gibt ein Ticket. Nummer unbekannt.
* Max wird angesprochen werden.
* Idee: Grundsätzlich neuer Aufbau
* nonpublic!
...
* Antwort: Schwierig.
* AIDS-Hilfe?
* Antwort: Schnackt Yannic mit Ed
* Kuhhirte?
* Yannic schickt ne Mail raus
